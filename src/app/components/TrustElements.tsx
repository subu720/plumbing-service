...
const defaultReviews: Review[] = [
  {
    ...
    avatar: 'SJ',
    rating: 5,
    text: 'Incredible service in Kodad! The plumber arrived in 20 minutes and fixed my burst pipe. The real-time tracking made me feel so secure.',
  ...
  },
  {
    ...
    avatar: 'MC',
    rating: 5,
    text: 'Finally, clear pricing in plumbing! No hidden fees, no surprises. The calculator was spot-on with the final price for our home near Khammam road.',
  ...
  },
  {
    ...
    avatar: 'ER',
    rating: 5,
    text: 'Professional, fast, and clean work. The plumber explained everything and gave me tips to prevent future issues. Highly recommend Patra Plumbing in Suryapet district!',
